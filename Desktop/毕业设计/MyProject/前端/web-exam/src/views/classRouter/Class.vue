  ...
  <div class="class">
    ...
    <div class="addUser">
      <el-button type="primary"
                 @click="showMain('ClassAdd')"><i class="el-icon-circle-plus-outline"></i> 添加班级</el-button>
    </div>
    <el-table :data="tableData"
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <el-button size="mini"
                     @click="classUpdate(scope.row)">编辑</el-button>
          <el-button size="mini"
                     type="danger"
...
export default {
  ...
  methods: {
    ...
    classUpdate(info) {
        console.log(info)
      this.$router.push({ name: 'ClassAdd', params:info })
    }
  },
  mounted() {
    this.getclasscount()
